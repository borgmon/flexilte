...
function K(t) {
	...
	for (let c = 0; c < e.length; c++) {
		const a = e[c].claim_order,
			u = (s > 0 && e[n[s]].claim_order <= a ? s + 1 : J(1, s, (R) => e[n[R]].claim_order, a)) - 1;
		i[c] = n[u] + 1;
		const k = u + 1;
...
class it {
	...
	m(e, n, i = null) {
		this.e ||
			(this.is_svg
				? (this.e = P(n.nodeName))
				: (this.e = N(n.nodeType === 11 ? 'TEMPLATE' : n.nodeName)),
...
function ct() {
	...
	do {
		...
		for (x(null), m.length = 0, _ = 0; C.length; ) C.pop()();
