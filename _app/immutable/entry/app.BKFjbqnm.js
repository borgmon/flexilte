const __vite__fileDeps = [
		'../nodes/0.lmgLn6bx.js',
		'../chunks/scheduler.DFLkqwTt.js',
		'../chunks/index.DThMT7MT.js',
		'../chunks/stores.BLu1vE7B.js',
		'../chunks/index.BrXgapp9.js',
		'../chunks/ProgressBar.svelte_svelte_type_style_lang.dhjFsQWZ.js',
		'../assets/ProgressBar.Cirlo5Z8.css',
		'../assets/0.D4X4yOIF.css',
		'../nodes/1.9Gq_TMlY.js',
		'../chunks/entry.BrxjhjPH.js',
		'../nodes/2.CrRGVQkf.js',
		'../chunks/ButtonBox.Csslo3Cz.js',
		'../chunks/ProgressRadial.DCQMZ2dH.js',
		'../nodes/3.CiM6_jRw.js',
		'../chunks/editorStore.q6LA20UU.js',
		'../nodes/4.4RKT41bL.js',
		'../chunks/Text.O-aUSI3U.js',
		'../nodes/5.B6t9CLad.js',
		'../nodes/6.4RKT41bL.js'
	],
...
const ae = [
		() =>
			k(
				() => import('../nodes/0.lmgLn6bx.js'),
				__vite__mapDeps([0, 1, 2, 3, 4, 5, 6, 7]),
				import.meta.url
			),
		() =>
			k(() => import('../nodes/1.9Gq_TMlY.js'), __vite__mapDeps([8, 1, 2, 9, 4]), import.meta.url),
		() =>
			k(
				() => import('../nodes/2.CrRGVQkf.js'),
				__vite__mapDeps([10, 1, 2, 11, 12, 5, 4, 6, 3]),
				import.meta.url
			),
		() =>
			k(
				() => import('../nodes/3.CiM6_jRw.js'),
				__vite__mapDeps([13, 1, 2, 11, 12, 5, 4, 6, 3, 14]),
				import.meta.url
			),
		() =>
			k(
				() => import('../nodes/4.4RKT41bL.js'),
				__vite__mapDeps([15, 1, 2, 16, 12, 5, 4, 6]),
				import.meta.url
			),
		() =>
			k(
				() => import('../nodes/5.B6t9CLad.js'),
				__vite__mapDeps([17, 1, 2, 11, 12, 5, 4, 6, 3, 14]),
				import.meta.url
			),
		() =>
			k(
				() => import('../nodes/6.4RKT41bL.js'),
				__vite__mapDeps([18, 1, 2, 16, 12, 5, 4, 6]),
				import.meta.url
			)
	],
	le = [],
	fe = { '/': [2], '/ai': [3], '/docs': [4], '/editor': [5], '/example': [6] },
	ce = {
		handleError: ({ error: a }) => {
			console.error(a);
		},
